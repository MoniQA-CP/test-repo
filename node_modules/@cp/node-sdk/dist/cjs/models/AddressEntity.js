...
exports.instanceOfAddressEntity = instanceOfAddressEntity;
exports.AddressEntityFromJSON = AddressEntityFromJSON;
exports.AddressEntityFromJSONTyped = AddressEntityFromJSONTyped;
exports.AddressEntityToJSON = AddressEntityToJSON;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the AddressEntity interface.
 */
function instanceOfAddressEntity(value) {
    let isInstance = true;
...
function AddressEntityFromJSON(json) {
    return AddressEntityFromJSONTyped(json, false);
}
function AddressEntityFromJSONTyped(json, ignoreDiscriminator) {
...
function AddressEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
