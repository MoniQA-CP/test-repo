...
exports.PaymentMethodEntityCurrencyEnum = exports.PaymentMethodEntityMethodEnum = exports.PaymentMethodEntityStatusEnum = void 0;
exports.instanceOfPaymentMethodEntity = instanceOfPaymentMethodEntity;
exports.PaymentMethodEntityFromJSON = PaymentMethodEntityFromJSON;
exports.PaymentMethodEntityFromJSONTyped = PaymentMethodEntityFromJSONTyped;
 ...
 * @export
 */
exports.PaymentMethodEntityStatusEnum = {
 ...
 * @export
 */
exports.PaymentMethodEntityMethodEnum = {
    Card: 'CARD',
    Bank: 'BANK'
};
/**
 ...
 */
function instanceOfPaymentMethodEntity(value) {
    let isInstance = true;
...
function PaymentMethodEntityFromJSON(json) {
    return PaymentMethodEntityFromJSONTyped(json, false);
}
function PaymentMethodEntityFromJSONTyped(json, ignoreDiscriminator) {
...
function PaymentMethodEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
