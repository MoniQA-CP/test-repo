...
exports.PaymentMethodSessionBaseEntityExpiredReasonEnum = exports.PaymentMethodSessionBaseEntityStatusEnum = void 0;
exports.instanceOfPaymentMethodSessionBaseEntity = instanceOfPaymentMethodSessionBaseEntity;
exports.PaymentMethodSessionBaseEntityFromJSON = PaymentMethodSessionBaseEntityFromJSON;
exports.PaymentMethodSessionBaseEntityFromJSONTyped = PaymentMethodSessionBaseEntityFromJSONTyped;
exports.PaymentMethodSessionBaseEntityToJSON = PaymentMethodSessionBaseEntityToJSON;
 ...
 * @export
 */
exports.PaymentMethodSessionBaseEntityStatusEnum = {
    Pending: 'PENDING',
    Expired: 'EXPIRED',
    Completed: 'COMPLETED'
};
 ...
 * @export
 */
exports.PaymentMethodSessionBaseEntityExpiredReasonEnum = {
    Timeout: 'TIMEOUT',
 ...
 */
function instanceOfPaymentMethodSessionBaseEntity(value) {
    let isInstance = true;
...
function PaymentMethodSessionBaseEntityFromJSON(json) {
    return PaymentMethodSessionBaseEntityFromJSONTyped(json, false);
}
function PaymentMethodSessionBaseEntityFromJSONTyped(json, ignoreDiscriminator) {
...
function PaymentMethodSessionBaseEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
