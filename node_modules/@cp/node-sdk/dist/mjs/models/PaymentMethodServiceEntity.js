 ...
 * @export
 */
export const PaymentMethodServiceEntityStatusEnum = {
 ...
 * @export
 */
export const PaymentMethodServiceEntityMethodEnum = {
    Card: 'CARD',
    Bank: 'BANK'
};
/**
 ...
 */
export function instanceOfPaymentMethodServiceEntity(value) {
    let isInstance = true;
...
export function PaymentMethodServiceEntityFromJSON(json) {
    return PaymentMethodServiceEntityFromJSONTyped(json, false);
}
export function PaymentMethodServiceEntityFromJSONTyped(json, ignoreDiscriminator) {
...
export function PaymentMethodServiceEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
